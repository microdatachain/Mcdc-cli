 ...
 * @param {Peer~getPeersCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Peer~getPeerCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Peer~versionCallback} cb - Callback handles response from mcdc.
 */
