 ...
 * @param {Sql~selectCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Sql~insertCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Sql~batchCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Sql~updateCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Sql~removeCallback} cb - Callback handles response from mcdc.
 */
