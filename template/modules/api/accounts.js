...
/**
 * Open account in mcdc.
 *
 * @param secret - Secret of account.
 * @param {Accounts~openCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Accounts~balanceCallback} cb - Callback handle response from mcdc.
 */
 ...
 * @param address - Address of account.
 * @param {Accounts~publicKeyCallback} cb - Callback handle response from mcdc.
 */
 ...
 *
 * @param address - Address of account.
 * @param {Accounts~delegatesCallback} cb - Callback handle response from mcdc.
 */
