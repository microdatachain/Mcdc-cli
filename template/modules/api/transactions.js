 ...
 * @param {Transactions~getTransactionsCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Transactions~getTransaction} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Transactions~getUnconfirmedTransaction} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Transactions~getUnconfirmedTransactions} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Transactions~addTransactionsCallback} cb - Callback handles response from mcdc.
 */
