 ...
 * @param {Delegates~getDelegateCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Delegates~getDelegatesCallback} cb - Callback handles response from mcdc.
 */
 ...
 *
 * @param {Delegates~getFeeCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Delegates~getForgedByAccount} cb - Callback handles response from mcdc.
 */
 ...
 * @param error - Error of api call execution.
 * @param response - Response of api call execution.
 * @param response.fees - Amount of mcdc that delegate forged.
 */
 ...
 * @param {Delegates~addDelegate} cb - Callback handles response from mcdc.
 */
