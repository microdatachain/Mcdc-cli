 ...
 *
 * @param id - Block id.
 * @param {Blocks~blockCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Blocks~getBlocksCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Blocks~getHeightCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Blocks~getFeeCallback} cb - Callback handles response from mcdc.
 */
