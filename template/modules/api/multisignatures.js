 ...
 * @param {Multisignatures~pendingCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Multisignatures~signCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Multisignatures~addCallback} cb - Callback handles response from mcdc.
 */
