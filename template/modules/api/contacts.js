 ...
 * @param {Contacts~getContactsCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Contacts~addContactCallback} cb - Callback handles response from mcdc
 */
 ...
 * @param {Contacts~getFeeCallback} cb - Callback handles response from mcdc.
 */
