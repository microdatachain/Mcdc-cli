 ...
 * @param {Dapps~getGenesisCallback} cb - Callback handles response from mcdc.
 */
 ...
 * @param {Dapps~sendWithdrawal} cb - Callback handles response from mcdc.
 */
 ...
 * @param cb - Callback handles response from mcdc.
 */
 ...
 * @param {Dapps~setReadyCallback} cb - Callback handles response from mcdc.
 */
